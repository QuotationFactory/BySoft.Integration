...
dotnet publish ../src/QF.BySoft.Integration -r win-x64 -p:PublishSingleFile=true /p:Version=$buildVersion -f net8.0 -p:IncludeAllContentForSelfExtract=true -c Release /p:DebugType=none /p:DebugSymbols=false -o ./published/Integration
