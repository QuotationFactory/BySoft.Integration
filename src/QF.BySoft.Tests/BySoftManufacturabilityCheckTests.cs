...
public class BySoftManufacturabilityCheckTests
{
    ...
    public BySoftManufacturabilityCheckTests()
    {
        // The constructor runs for every test, so variables will be reset before each test.
        _mockLogger = new Mock<ILogger<BySoftManufacturabilityCheck>>();
    ...
    public async Task ManufacturabilityCheckShouldCreateResponse()
    {
        ...
        var featuresMappingRepository = FeaturesMappingRepositoryMock(_machineIntegration);
        ...
        var sut = new BySoftManufacturabilityCheck(
            ...
            featuresMappingRepository.Object,
            _mockLogger.Object,
    ...
    [Fact]
    public async Task ResourceIntegrationNotFoundShouldThrowError()
    {
        // Arrange
        var bySoftIntegrationSettings = SettingsBuilder.GetBySoftIntegrationSettings();
    ...
    private static Mock<IResourceMappingRepository> ResourceMappingRepositoryMock(string machineIntegration)
    {
        ...
        machineRepositoryMock
            .Setup(x => x.GetBySoftMachineName(It.IsAny<string>()))
    ...
    private static Mock<IFeaturesMappingRepository> FeaturesMappingRepositoryMock(string machineIntegration)
    {
        var featuresMappingRepositoryMock = new Mock<IFeaturesMappingRepository>();
        featuresMappingRepositoryMock
            .Setup(x => x.GetCustomFeatureDescription(It.IsAny<string>()))
            .Returns(machineIntegration);
        return featuresMappingRepositoryMock;
    }
